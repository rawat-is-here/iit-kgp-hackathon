...
for name, model in models.items():
    ...
    # We will do a manual cross-validation loop to scale features correctly for SVR/MLP
    rmses = []
    best_params_list = []
    
    # Run Grid Search within each fold to prevent data leakage during scaling
