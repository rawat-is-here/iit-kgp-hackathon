...
# Define the global outliers to remove based on our previous run
# Let's try removing different numbers of the top outliers
...
for n_remove in [0, 1, 2, 3, 5, 8, 10]:
    ...
    for train_idx, val_idx in cv.split(X):
        ...
        # Scale based on clean training set
